...
export const VideoInfoSection = ({
  ...
  const handleDownload = async () => {
    ...
    // Список файлов от прошлого скачивания сбрасываем здесь, а не только при
    // смене вкладки: иначе, скачав карусель и запустив следом обычное видео,
    // человек видел бы под ним старый список чужих файлов.
    setPostItems([]);
    setDownloadState({
      status: "downloading",
      progress: 0,
