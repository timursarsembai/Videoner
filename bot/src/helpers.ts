...
// выдаётся только вручную админом через /grant.
// Падает открыто (не блокирует скачивание, remaining = Infinity), если сервер
// недоступен, чтобы сбой проверки лимита не клал бота.
