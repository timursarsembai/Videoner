...
const en = {
  ...
  platforms: {
    youtube: {
      ...
      faq: [
        { q: "Is downloading YouTube videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    facebook: {
      ...
      faq: [
        { q: "Is downloading Facebook videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    instagram: {
      ...
      faq: [
        { q: "Is downloading Instagram content with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    tiktok: {
      ...
      faq: [
        { q: "Is downloading TikTok videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    twitter: {
      ...
      faq: [
        { q: "Is downloading Twitter/X videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    vimeo: {
      ...
      faq: [
        { q: "Is downloading Vimeo videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    vk: {
      ...
      faq: [
        { q: "Is downloading VK videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    rutube: {
      ...
      faq: [
        { q: "Is downloading Rutube videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    okru: {
      ...
      faq: [
        { q: "Is downloading OK.ru videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
    ...
    pinterest: {
      ...
      faq: [
        { q: "Is downloading Pinterest videos with Videoner free?", a: "Yes — but you need to log in with Telegram first (one click, no password). You get 10 free downloads a day, shared with our Telegram bot; HD quality (720p and up) requires an active subscription." },
        { q: "Do I need an account to download?", a: "You need to log in with your Telegram account before starting a download — it's one click, no email or password required. Browsing the page and checking available qualities doesn't require logging in." },
        { q: "How do I unlock HD quality and unlimited downloads?", a: "Subscribe from our Telegram bot @VideonerBot using Telegram Stars — a monthly or yearly plan removes the daily limit and unlocks HD (720p and up) on both the website and the bot, since they use the same account." },
        { q: "Can I unlock HD for just one download, without subscribing?", a: "Yes — in our Telegram bot you can pay 15 Telegram Stars (~$0.30) to unlock HD for a single download, no subscription needed. This one-time option only exists in the bot, not on the website." },
...
const es: Translations = {
  ...
  platforms: {
    youtube: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de YouTube con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    facebook: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de Facebook con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    instagram: {
      ...
      faq: [
        { q: "¿Es gratis descargar contenido de Instagram con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    tiktok: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de TikTok con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    twitter: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de Twitter/X con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    vimeo: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de Vimeo con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    vk: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de VK con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    rutube: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de Rutube con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    okru: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de OK.ru con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
    ...
    pinterest: {
      ...
      faq: [
        { q: "¿Es gratis descargar videos de Pinterest con Videoner?", a: "Sí — pero primero debes iniciar sesión con Telegram (un clic, sin contraseña). Obtienes 10 descargas gratis al día, compartidas con nuestro bot de Telegram; la calidad HD (720p o superior) requiere una suscripción activa." },
        { q: "¿Necesito una cuenta para descargar?", a: "Debes iniciar sesión con tu cuenta de Telegram antes de descargar — es un clic, sin correo ni contraseña. Ver la página y las calidades disponibles no requiere iniciar sesión." },
        { q: "¿Cómo desbloqueo la calidad HD y las descargas ilimitadas?", a: "Suscríbete desde nuestro bot de Telegram @VideonerBot usando Telegram Stars — un plan mensual o anual elimina el límite diario y desbloquea HD (720p o superior) tanto en el sitio web como en el bot, ya que comparten la misma cuenta." },
        { q: "¿Puedo desbloquear HD para una sola descarga, sin suscribirme?", a: "Sí — en nuestro bot de Telegram puedes pagar 15 Telegram Stars (~$0.30) para desbloquear HD en una sola descarga, sin necesidad de suscripción. Esta opción de pago único solo existe en el bot, no en el sitio web." },
...
const ru: Translations = {
  ...
  platforms: {
    youtube: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео с YouTube через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    facebook: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео с Facebook через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    instagram: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать контент Instagram через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    tiktok: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео из TikTok через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    twitter: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео из Twitter через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    vimeo: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео с Vimeo через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    vk: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео из VK через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    rutube: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео с Rutube через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    okru: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео с OK.ru через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
    ...
    pinterest: {
      ...
      faq: [
        { q: "Бесплатно ли скачивать видео с Pinterest через Videoner?", a: "Да — но сначала нужно войти через Telegram (один клик, без пароля). Вы получаете 10 бесплатных скачиваний в день, общих с нашим Telegram-ботом; HD-качество (720p и выше) требует активной подписки." },
        { q: "Нужен ли аккаунт для скачивания?", a: "Перед скачиванием нужно войти через свой аккаунт Telegram — это один клик, без email и пароля. Просмотр страницы и доступных качеств входа не требует." },
        { q: "Как открыть HD-качество и безлимитные скачивания?", a: "Оформите подписку в нашем Telegram-боте @VideonerBot через Telegram Stars — месячный или годовой план снимает дневной лимит и открывает HD (720p и выше) как на сайте, так и в боте, поскольку это один и тот же аккаунт." },
        { q: "Можно открыть HD для одного скачивания, без подписки?", a: "Да — в нашем Telegram-боте можно заплатить 15 Telegram Stars (~$0.30) и открыть HD для одного скачивания, без подписки. Такая разовая оплата есть только в боте, на сайте её нет." },
