...
export enum VideoQuality {
  // Facebook отдаёт H.264 только двумя прогрессивными форматами — их и
  // показываем как качества (`getPlatformFormats` в info.service.ts), потому
  // что ни ширины, ни высоты у них в метаданных нет. Это не «лишние» значения:
  // именно их шлют обратно бот и сайт, и без них тип врал про то, что реально
  // приходит в quality — из-за чего ветка обработки Facebook в
  // parseDownloadOptions однажды уехала в прод недостижимой (19.08.2026).
  'hd' = 'hd',
  'sd' = 'sd',
  '144p' = '144p',
  '240p' = '240p',
